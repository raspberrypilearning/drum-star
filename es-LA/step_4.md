...
**Prueba:** Pon tu proyecto a prueba.
...
Colócalo en la esquina inferior derecha del Escenario:
...
Haz clic en la imagen **Redoblante** y ve a la pestaña **Estilos**.

![](images/snare-icon.png)

Use the **Select** (arrow) tool to highlight the 'not hit' costume of your drum. Haz clic en el icono **Grupo** y luego en **Copiar**:
